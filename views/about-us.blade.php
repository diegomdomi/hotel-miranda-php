...
<div class="about-us__home">
        ...
        <h1>About Us</h1>
        <div class="about-us__home-about"><h6>Home | <span>About</span></h6></div>
    </div>
    ...
    <div class="about-us__icons">
        <div class="about-us__icons-group">
            ...
            <div>
                <img  class="about-us__icons-plane" src="./Assets/icon 12.png" alt="plane-icon">
                <p>AIRPORT PICKUP</p>
            </div>
        </div>
        <div class="about-us__icons-group">
    ...
    <section class="facilities about-us__facilities">
        <h6>FACILITIES</h6>
        <h2>Core Features</h2>
        <div class="about-us__facilities_background">
        ...
        <div class="high-rating">
            <img  src="./Assets/Frame 90.png" alt="">
        </div>
    </section>  
