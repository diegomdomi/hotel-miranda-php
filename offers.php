...
?>
 <!-- about-Us -->
  <div class="about-us__home">
        ...
        <h1>Our Offers</h1>
        <div class="about-us__home-about"><h6>Home | <span>Offers</span></h6></div>
    </div>
    <div class="offers">
        <div class="offers__prices">
            <img src="./Assets/img-room/room1.jpg" alt="room-luxury">
            <div class="offers__prices-text">
                <h5>$500<sub>/Night</sub></h5>
                <h5>$345<sub>/Night</sub></h5>
            </div>
        </div>
        <h6>DOUBLE BED</h6>
        <h1 class="offers__title">Luxury Double Bed</h1>
    ...
    <div class="room-card card-background">
        <h4>POPULAR LIST</h4>
        <h2>Popular Rooms</h2>
        <div class="room__slider card-background__slider">
            <div class="swiper">
